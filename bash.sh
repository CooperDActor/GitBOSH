...
sudo apt install argyll libavahi-core7 libdaemon0 libnss-mdns brz libjs-sphinxdoc libgoa-1.0-0b libimobiledevice6 libmtp9   libsmbclient gnome-keyring cups hplip-data libhpmud0 printer-driver-hpcups python3-pil python3-reportlab printer-driver-postscript-hp libi2c0 libalgorithm-diff-perl libasprintf0v5 libvolume-key1 libbytesize1 libdevel-caller-perl libgettextpo0  gdbserver g++    glibc-doc-reference libaa1 libcdk5nc6 libavahi-glib1 libcdio-cdda2 libcdio-paranoia2  libgdata22 zfs-zed libdevel-callchecker-perl libdynaloader-functions-perl libctf-nobfd0 libb-hooks-op-check-perl libctf0 libgail18 libitm1 libatomic1  liblsan0 libtsan0 libubsan1  libparams-classify-perl mysql-common libbinutils binutils-common binutils-x86-64-linux-gnu  libcc1-0 lib-dev pkg-config libexif12 libgd3 libgtk2.0-common libgail-common libgtk2.0-bin libimport-into-perl libmodule-runtime-perl librole-tiny-perl libsub-quote-perl libnet-ip-perl libdigest-bubblebabble-perl libnet-dns-sec-perl libnet-libidn-perl libperl4-corelibs-perl  libsnmp-base libxml-sax-base-perl libxml-sax-expat-perl update-inetd containerd autoconf autotools-dev binutils libcairo-5c0 runc uuid-dev libblkid-dev docker.io  wget  libterm-size-perl rpm rpm2cpio smistrip curl -y 
sudo apt --fix-broken install -y
sudo apt install argyll libavahi-core7 libdaemon0 libnss-mdns brz libjs-sphinxdoc libgoa-1.0-0b libimobiledevice6 libmtp9   libsmbclient gnome-keyring cups hplip-data libhpmud0 printer-driver-hpcups python3-pil python3-reportlab printer-driver-postscript-hp libi2c0 libalgorithm-diff-perl libasprintf0v5 libvolume-key1 libbytesize1 libdevel-caller-perl libgettextpo0  gdbserver g++    glibc-doc-reference libaa1 libcdk5nc6 libavahi-glib1 libcdio-cdda2 libcdio-paranoia2  libgdata22 zfs-zed libdevel-callchecker-perl libdynaloader-functions-perl libctf-nobfd0 libb-hooks-op-check-perl libctf0 libgail18 libitm1 libatomic1  liblsan0 libtsan0 libubsan1  libparams-classify-perl mysql-common libbinutils binutils-common binutils-x86-64-linux-gnu  libcc1-0 lib-dev pkg-config libexif12 libgd3 libgtk2.0-common libgail-common libgtk2.0-bin libimport-into-perl libmodule-runtime-perl librole-tiny-perl libsub-quote-perl libnet-ip-perl libdigest-bubblebabble-perl libnet-dns-sec-perl libnet-libidn-perl libperl4-corelibs-perl  libsnmp-base libxml-sax-base-perl libxml-sax-expat-perl update-inetd containerd autoconf autotools-dev binutils libcairo-5c0 runc uuid-dev libblkid-dev  docker.io  wgetlibterm-size-perl rpm rpm2cpio smistrip curl -y 
sudo apt --fix-broken install -y
